...
<html>
	...
	<body class="pattern">
		<?php
			...
			$connection = mysqli_connect("localhost", "jeremy", "Snakes12", "auto");
					...
					<div class="content">
						<form class="form" method="post" role="form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
							...
							<div class="form-group">
								...
								<input type="password" class="form-control" name="phoneNumber" placeholder="Phone Number ex. 555-555-5555">
							</div>
